...
//---------------------------------------------------------------------------------------------
    ...
    // Die Drive-Download-URL muss mit einem Token versehen werden, 
    // um den Download direkt zu erzwingen, wenn sie über Javascript aufgerufen wird.
    // getDownloadUrl() enthält bereits das notwendige `export` und den `authuser`-Parameter,
    // aber wir verwenden einen Trick mit einem temporären Link.
    ...
    // Beachten Sie: Dies wird von manchen Browsern ignoriert, aber es ist guter Stil.
    link.download = name; 
